    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0, y: -10 }}
          className={cn(
            "absolute inset-x-0 top-16 z-50 flex w-full flex-col items-start justify-start gap-4 rounded-lg bg-card px-4 py-8 shadow-lg",
            className
          )}
        >
          {children}
...
export const NavbarLogo = ({
  ...
  return (
    <Link to="/" className="relative z-20 flex items-center gap-2">
      <img src={logo} alt={alt} className="h-10 md:h-12 w-auto" />
    </Link>
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    primary:
      "bg-accent text-accent-foreground shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]",
